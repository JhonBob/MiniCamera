package com.hongyue.app.camera.tool;
...
//                return size;
    ...
    /**
     *  Description:  google 的算法
     *  Author: Charlie
     *  Data: 2019/7/29  11:22
     *  Declare: None
     */

    private static Size chooseOptimalSizes(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            ...
            return Collections.max(notBigEnough, new CompareSizesByArea2());
        } else {
            Log.e(TAG, "Couldn't find any suitable preview size");
            return choices[0];
        }
